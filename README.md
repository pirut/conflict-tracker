...
## What It Does
- Aggregates **Confirmed News** (GDELT, optional NewsAPI)
- Aggregates **Signals** (NASA FIRMS, OpenSky flight snapshots, pluggable connectivity adapter)
- Supports optional **Social feed** adapter (disabled by default, always unverified)
